...
DEMO_POSTS_TEMPLATES = [
    {
        "content": "今天A股放量上涨，上证突破3400点，成交额突破万亿。#A股# 主力资金大幅流入半导体和新能源板块，看多后市，建议逢低加仓科技股。$宁德时代$（300750） $中芯国际$（688981）",
        "market_view": "bullish",
        "reposts": (500, 2000),
        "comments": (200, 800),
        "attitudes": (1000, 5000),
    ...
    {
        "content": "光伏板块迎来政策利好！发改委发布新能源发展规划，2025年装机目标上调。#光伏# #新能源# 龙头隆基绿能、通威股份值得关注，做多新能源赛道。$隆基绿能$（601012） $通威股份$（600438）",
        "market_view": "bullish",
        "reposts": (600, 2500),
        "comments": (250, 900),
        "attitudes": (1500, 6000),
    ...
    {
        "content": "白酒板块今天逆势上涨，茅台创历史新高。#白酒# 消费复苏逻辑持续验证，看多消费龙头。$贵州茅台$（600519） $五粮液$（000858） 长期持有不动摇。",
        "market_view": "bullish",
        "reposts": (900, 3500),
        "comments": (400, 1500),
    ...
    {
        "content": "半导体设备国产替代加速！中芯国际产能利用率回升至90%。#半导体# #芯片# 看多国产芯片产业链，重点关注设备和材料环节。$北方华创$（002371） $中微公司$（688012）",
        "market_view": "bullish",
        "reposts": (500, 2200),
        "comments": (200, 800),
        "attitudes": (1200, 5500),
    ...
    {
        "content": "医药板块持续调整，集采压力下创新药企业承压。#医药# 短期看空医药，但长期关注创新药和CXO龙头的估值修复机会。$药明康德$（603259） $恒瑞医药$（600276）",
        "market_view": "bearish",
        "reposts": (300, 1200),
        "comments": (150, 550),
        "attitudes": (600, 2800),
